...
public class TriptimizePermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasPermission(Authentication authentication, Serializable targetId, String targetType, Object permission) {
        ...
        try {
            ...
            throw new IllegalArgumentException("The permission must be a valid TriptimizePermission");
        }
        ...
        switch(targetType.toLowerCase()) { 
            case "itinerary" -> {
                ...
                if(!itineraryOptional.isPresent()) {
                    throw new EntityNotFoundException("Itinerary with id " + targetId + " not found");
                }
            ...
            case "account" -> {
                ...
                // TODO: Fix the permissions because all return true and does not handle each seperatly.
                switch (permissions) {
                    case READ, WRITE, DELETE -> { 
                        return true; 
                    }
